...
export function ProductProblemPanel({ stats, baseUrl = "/anbar/mehsullar" }: Props) {
  const cards: Card[] = [
    ...
    { label: "Şəkilsiz",          value: stats.sekilsiz,      icon: ImageIcon,     href: `${baseUrl}?sekil=no`,            tone: "warning" },
    { label: "Qiymətsiz",         value: stats.qiymetsiz,     icon: DollarSign,    href: `${baseUrl}?qmax=0`,              tone: "warning" },
    { label: "Barkodsuz",         value: stats.barkodsuz,     icon: Barcode,       href: `${baseUrl}?barkod=no`,           tone: "warning" },
