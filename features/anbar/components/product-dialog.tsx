...
import { Plus, Loader2, Pencil, Upload, Sparkles, Wand2 } from "lucide-react";
...
export function ProductDialog({ categories, brands, units = [], initial, trigger = "new" }: Props) {
            ...
            <div className="space-y-2">
              ...
              <div className="relative h-24 w-full overflow-hidden rounded-md border border-border bg-secondary/30">
                {sekilUrl ? (
                  ...
                  <img src={sekilUrl} alt="" className="h-full w-full object-cover" onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = "none"; }} />
                ) : (
