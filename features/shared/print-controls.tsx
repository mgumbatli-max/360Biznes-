...
/**
 * Universal print controls — istənilən printable səhifədə istifadə oluna bilər.
 * `?auto=1` URL-parametri ilə avtomatik çap pəncərəsi açılır.
 */
export function UniversalPrintControls({
  backHref,
  backLabel = "Geri",
}: {
  backHref: string;
