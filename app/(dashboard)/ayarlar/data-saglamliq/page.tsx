...
async function runHealthChecks(): Promise<Check[]> {
  return withTenant(async () => {
    ...
    return [
      ...
      { key: "dead_stock", label: "60+ gün satılmayan", description: "Ölü stok riski — endirim və ya çıxarış", count: deadStock60d, total: totalProducts, link: "/anbar/hesabat?mod=satilmayan_60", icon: Clock, tone: deadStock60d > 5 ? "warning" : "info" },
