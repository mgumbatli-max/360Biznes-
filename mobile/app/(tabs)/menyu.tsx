...
export default function ModullarScreen() {
  ...
  const allTiles: Tile[] = [
    ...
    { label: "Əməkdaşlar", Icon: UserCog, fg: "#0d9488", onPress: () => router.push("/emekdas"), seg: "iscilier" },
    ...
    { label: "Kampaniyalar", Icon: Megaphone, fg: "#db2777", onPress: () => router.push("/kampaniya") },
    ...
    { label: "Nəzarət Mərkəzi", Icon: ShieldAlert, fg: "#dc2626", onPress: () => router.push("/nezaret") },
    { label: "Sahibkar", Icon: Crown, fg: "#d97706", onPress: () => router.push("/sahibkar") },
